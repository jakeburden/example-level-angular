...
const app = angular.module('BLAN', [])

require('./service')
require('./controller')

},{"./controller":2,"./service":4,"angular":7}],2:[function(require,module,exports){
const app = require('angular').module('BLAN')

app.controller('usersController', ['$scope', 'users', require('./usersController')])

},{"./usersController":3,"angular":7}],3:[function(require,module,exports){
...
},{"./users":5,"angular":7}],5:[function(require,module,exports){
